...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{micado_static_surfaces.png}}\phantomsection\label{fig-micado-static-surfaces}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{micado_ncpas_psf.png}}\phantomsection\label{fig-micado-ncpas-psf}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{filter_wheel_1.png}}\phantomsection\label{fig-filter-wheel-1}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{filter_wheel_2.png}}\phantomsection\label{fig-filter-wheel-2}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{pupil_wheel.png}}\phantomsection\label{fig-pupil-wheel}
\end{figure}

...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics[scale=0.900000]{../images/Ecosystem.png}}\phantomsection\label{fig-ecosystem}
\end{figure}
...
{\color{red}ERROR/3} in \texttt{<string>}, line~66
...
{\color{red}ERROR/3} in \texttt{<string>}, line~86
...
Currently Scopesim\_templates splits the helper functions into categories based on the complexity of the Source object that is produced.
...
{\color{red}ERROR/3} in \texttt{<string>}, line~145

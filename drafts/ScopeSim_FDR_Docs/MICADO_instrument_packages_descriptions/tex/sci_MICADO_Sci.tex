...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{micado_common_optics.png}}\phantomsection\label{fig-micado-common-optics}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{filter_wheel.png}}\phantomsection\label{fig-filter-wheel}
\end{figure}

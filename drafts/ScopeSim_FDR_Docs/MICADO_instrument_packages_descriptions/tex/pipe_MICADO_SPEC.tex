...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{spec_mode_optics.png}}\phantomsection\label{fig-spec-mode-optics}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{micado_spectral_traces.png}}\phantomsection\label{fig-micado-spectral-traces}
\end{figure}

...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{maory_mms_ter.png}}\phantomsection\label{fig-maory-mms-ter}
\end{figure}
...
\begin{figure}[H]
\noindent\makebox[\linewidth][c]{\includegraphics{maory_const_psf.png}}\phantomsection\label{fig-maory-const-psf}
\end{figure}

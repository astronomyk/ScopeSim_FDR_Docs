...
The \scopesimtemplates{} package provides a series of functions to
...
\ScopeSim{} aims to be a general-purpose instrument data simulator
...
The configuration files are written in the YAML\footnote{YAML is a
